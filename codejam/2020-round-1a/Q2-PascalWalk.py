"""
Very similar to 2019 round 1a Q1. We go as deepest as possible, prioritizing the move with large increment of value.
int() method is required to cast factorial to integer, otherwise precision issues raised for high value of "n"
"""
import math
global visited
global nCr_cache
...
def nCr(pos):
    ...
    if pos in nCr_cache:
        ...
        n, r = pos[0] - 1, pos[1] - 1
        f = math.factorial
        value = int(f(n)) // int(f(r)) // int(f(n-r))
